...
class GetChannels:
    def __init__(self, url: str = None, host: str = None, port: int = None, 
        ...
        self.sport_keywords = ["SPORT", "SPORTS", "Thể thao", "LIVE", "Live", "Spor", "Sport", "Matches", "MATCHES", "Direct", "DIRECT", "Event", "EVENT", "Events", "EVENTS", "Hub Premier", "EPL", "Football", "La Liga", "UEFA", "Premier League", "Golf", "Tennis", "Viaplay"]
